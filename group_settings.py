...
class GroupSettingsManager:
    ...
    def set_custom_patterns(self, group_id: str, amount_pattern: str, payer_pattern: str, identifier: str) -> bool:
        ...
        return self.update_group_settings(group_id, {
            'payment_source': 'custom',
    ...
    def get_payment_config(self, group_id: str) -> Dict[str, Any]:
        ...
        return self.default_sources.get(source_key, self.default_sources['kb_prasac_merchant_payment'])
