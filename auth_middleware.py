...
class AuthMiddleware:
    ...
    async def authenticate_group(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> Optional[Dict[str, Any]]:
...
Contact support: support@paymentbot.com
    ...
    def log_transaction(self, client: Dict[str, Any], transaction_data: Dict[str, Any]):
        ...
        if client:
            ...
            logger.info(f"Transaction recorded for client {client_id}: ${transaction_data.get('amount')} from {transaction_data.get('payer')}")
